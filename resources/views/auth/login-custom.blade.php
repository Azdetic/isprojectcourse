...
<body class="min-h-screen bg-white relative overflow-x-hidden">
    ...
    <div class="absolute top-6 right- z-20 hidden md:block">
        <a href="{{ route('signup') }}" class="px-6 py-2 border border-white text-white rounded-full text-sm font-semibold hover:bg-white/10 transition">
            SIGN UP
        </a>
    </div>
            ...
            <form action="{{ route('login.store') }}" method="POST" class="space-y-5">
                ...
                <div class="flex items-center justify-between text-sm">
                    <label class="flex items-center space-x-2 cursor-pointer">
                        <input type="checkbox" name="remember" class="w-4 h-4 border-gray-300 rounded text-red-600 focus:ring-red-500">
                        <span class="text-gray-500 text-xs">Remember Me</span>
                    </label>
                    <a href="#" class="text-gray-500 text-xs underline hover:text-red-600">Forgot Password?</a>
                </div>
                ...
                <div class="relative flex py-2 items-center">
                    ...
                    <span class="flex-shrink-0 mx-4 text-gray-400 text-[10px] uppercase tracking-widest">OR</span>
                    <div class="flex-grow border-t border-gray-200"></div>
                </div>
